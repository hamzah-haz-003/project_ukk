      ...
      <div class="card shadow">
        ...
        <div class="card-body">
          ...
          <small class="text-muted">
            <?= date('D,d M Y H:i:s', $pengaduan->id_pengaduan); ?>
          </small>
          <hr>
          <button type="button" class="btn btn-success" data-toggle="modal" data-target="#modal"><i
              class="fa fa-edit"></i> Edit Status</button>
        </div>
      </div>
    </div>
      ...
      <div class="card shadow">
        <div class="card-body">
          ...
          <form action="<?= base_url('pengaduan/add_tanggapan/') . $pengaduan->id_pengaduan; ?>" method="post">
            ...
            <textarea name="tanggapan" rows="3" class="form-control" placeholder="Tambahkan tanggapan"
              required></textarea>
